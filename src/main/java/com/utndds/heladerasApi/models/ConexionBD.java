...
public class ConexionBD {
  ...
  public static Connection getConnection() {
        ...
        try {
            ...
            System.out.println("Error al conectar con la base de datos: " + e.getMessage()); // Mensaje de error más claro
        }
        
        return conexion;
  }
  public static void insertarUsuarioHumano(Connection con, String nombre, String apellido, String fechaNacimiento, String colaboracion) {
    try {
