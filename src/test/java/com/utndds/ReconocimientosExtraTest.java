...
public class ReconocimientosExtraTest {
    ...
    public void testRecomendarColaboradores_CumplenRequisitos() {
        ...
        when(calculadoraPuntosService.calcularPuntos(colaborador1.getUUID())).thenReturn(150.0);
        when(calculadoraPuntosService.calcularPuntos(colaborador2.getUUID())).thenReturn(200.0);
    ...
    public void testRecomendarColaboradores_NoCumplenRequisitos() {
        ...
        // Mock puntos de colaboradores
        when(calculadoraPuntosService.calcularPuntos(colaborador1.getUUID())).thenReturn(50.0); // No alcanza el mínimo
        when(calculadoraPuntosService.calcularPuntos(colaborador2.getUUID())).thenReturn(80.0); // No alcanza el mínimo
