...
function InfoApp() {
    return (
      <div className={'info-container d-flex flex-column justify-content-center align-items-center'}>
        <p className='text-wrap pt-5 fs-3 fw-normal text-break w-50 text-center'>
